...
########
GPU=3
SAVE_PATH=./triplet_net_ce_101_07_03_00_WN_02
RESNET=resnet-50
CONTINUE=""
...
export CUDA_VISIBLE_DEVICES=$GPU; th ./train.lua \
 ...
 --model $MODEL \
 --net_config "{cinput_planes=3, image_size=224, class_count=3, model_file='$RESNET.t7', fc_dropout=0.7, tripletnet=true, white_noise={mean=0, std=0.05} }" \
